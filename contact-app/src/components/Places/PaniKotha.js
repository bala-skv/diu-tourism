  ...
  return (
    <div className="nagoa-page">
      ...
      <div className="places-links">
          ...
          <li>
            <Link to="/places/DiuFort" className={location.pathname === "/places/PaniKotha" ? "active-link" : ""}>
              Forts
            </Link>
          </li>
          <li>
      ...
      <div className="places-links">
        <ul>
          ...
          <li>
            <Link to="/places/PaniKotha" className={location.pathname === "/places/PaniKotha" ? "active-link" : ""}>
              Pani Kotha
            </Link>
          </li>
        </ul>
